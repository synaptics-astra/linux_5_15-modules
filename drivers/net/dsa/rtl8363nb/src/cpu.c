...
EXPORT_SYMBOL(rtk_cpu_enable_set);
EXPORT_SYMBOL(rtk_cpu_enable_get);
EXPORT_SYMBOL(rtk_cpu_tagPort_set);
EXPORT_SYMBOL(rtk_cpu_tagPort_get);
EXPORT_SYMBOL(rtk_cpu_awarePort_set);
EXPORT_SYMBOL(rtk_cpu_awarePort_get);
EXPORT_SYMBOL(rtk_cpu_tagPosition_set);
EXPORT_SYMBOL(rtk_cpu_tagPosition_get);
EXPORT_SYMBOL(rtk_cpu_tagLength_set);
EXPORT_SYMBOL(rtk_cpu_tagLength_get);
EXPORT_SYMBOL(rtk_cpu_acceptLength_set);
EXPORT_SYMBOL(rtk_cpu_acceptLength_get);
EXPORT_SYMBOL(rtk_cpu_priRemap_set);
EXPORT_SYMBOL(rtk_cpu_priRemap_get);
