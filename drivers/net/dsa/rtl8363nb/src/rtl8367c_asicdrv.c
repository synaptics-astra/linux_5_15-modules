...
EXPORT_SYMBOL(rtl8367c_setAsicRegBit);
EXPORT_SYMBOL(rtl8367c_getAsicRegBit);
EXPORT_SYMBOL(rtl8367c_setAsicRegBits);
EXPORT_SYMBOL(rtl8367c_getAsicRegBits);
EXPORT_SYMBOL(rtl8367c_setAsicReg);
EXPORT_SYMBOL(rtl8367c_getAsicReg);
