...
EXPORT_SYMBOL(rtk_trap_unknownUnicastPktAction_set);
EXPORT_SYMBOL(rtk_trap_unknownUnicastPktAction_get);
EXPORT_SYMBOL(rtk_trap_unknownMacPktAction_set);
EXPORT_SYMBOL(rtk_trap_unknownMacPktAction_get);
EXPORT_SYMBOL(rtk_trap_unmatchMacPktAction_set);
EXPORT_SYMBOL(rtk_trap_unmatchMacPktAction_get);
EXPORT_SYMBOL(rtk_trap_unmatchMacMoving_set);
EXPORT_SYMBOL(rtk_trap_unmatchMacMoving_get);
EXPORT_SYMBOL(rtk_trap_unknownMcastPktAction_set);
EXPORT_SYMBOL(rtk_trap_unknownMcastPktAction_get);
EXPORT_SYMBOL(rtk_trap_lldpEnable_set);
EXPORT_SYMBOL(rtk_trap_lldpEnable_get);
...
EXPORT_SYMBOL(rtk_trap_rmaKeepFormat_set);
EXPORT_SYMBOL(rtk_trap_rmaKeepFormat_get);
