...
EXPORT_SYMBOL(rtk_storm_bypass_set);
EXPORT_SYMBOL(rtk_storm_bypass_get);
EXPORT_SYMBOL(rtk_rate_stormControlExtPortmask_set);
EXPORT_SYMBOL(rtk_rate_stormControlExtPortmask_get);
EXPORT_SYMBOL(rtk_rate_stormControlExtEnable_set);
EXPORT_SYMBOL(rtk_rate_stormControlExtEnable_get);
EXPORT_SYMBOL(rtk_rate_stormControlExtMeterIdx_set);
EXPORT_SYMBOL(rtk_rate_stormControlExtMeterIdx_get);
