...
EXPORT_SYMBOL(rtk_mirror_vlanLeaky_set);
EXPORT_SYMBOL(rtk_mirror_vlanLeaky_get);
EXPORT_SYMBOL(rtk_mirror_isolationLeaky_set);
EXPORT_SYMBOL(rtk_mirror_isolationLeaky_get);
EXPORT_SYMBOL(rtk_mirror_keep_set);
EXPORT_SYMBOL(rtk_mirror_keep_get);
