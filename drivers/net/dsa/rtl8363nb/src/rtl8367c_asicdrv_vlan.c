...
EXPORT_SYMBOL(rtl8367c_setAsicVlanIngressFilter);
EXPORT_SYMBOL(rtl8367c_setAsicVlanEgressTagMode);
EXPORT_SYMBOL(rtl8367c_setAsicVlanPortBasedVID);
EXPORT_SYMBOL(rtl8367c_setAsicVlanFilter);
