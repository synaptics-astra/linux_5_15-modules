...
EXPORT_SYMBOL(rtk_int_polarity_set);
EXPORT_SYMBOL(rtk_int_polarity_get);
EXPORT_SYMBOL(rtk_int_control_set);
EXPORT_SYMBOL(rtk_int_control_get);
EXPORT_SYMBOL(rtk_int_status_set);
EXPORT_SYMBOL(rtk_int_status_get);
EXPORT_SYMBOL(rtk_int_advanceInfo_get);
