...
EXPORT_SYMBOL(rtk_filter_igrAcl_cfg_del);
EXPORT_SYMBOL(rtk_filter_igrAcl_cfg_delAll);
EXPORT_SYMBOL(rtk_filter_igrAcl_cfg_get);
EXPORT_SYMBOL(rtk_filter_igrAcl_unmatchAction_set);
EXPORT_SYMBOL(rtk_filter_igrAcl_unmatchAction_get);
EXPORT_SYMBOL(rtk_filter_igrAcl_state_set);
EXPORT_SYMBOL(rtk_filter_igrAcl_state_get);
EXPORT_SYMBOL(rtk_filter_igrAcl_template_set);
EXPORT_SYMBOL(rtk_filter_igrAcl_template_get);
EXPORT_SYMBOL(rtk_filter_igrAcl_field_sel_set);
EXPORT_SYMBOL(rtk_filter_igrAcl_field_sel_get);
EXPORT_SYMBOL(rtk_filter_iprange_set);
EXPORT_SYMBOL(rtk_filter_iprange_get);
EXPORT_SYMBOL(rtk_filter_vidrange_set);
EXPORT_SYMBOL(rtk_filter_vidrange_get);
EXPORT_SYMBOL(rtk_filter_portrange_set);
EXPORT_SYMBOL(rtk_filter_portrange_get);
EXPORT_SYMBOL(rtk_filter_igrAclPolarity_set);
EXPORT_SYMBOL(rtk_filter_igrAclPolarity_get);
