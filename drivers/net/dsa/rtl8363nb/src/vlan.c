...
//EXPORT_SYMBOL(rtk_vlan_clear);
EXPORT_SYMBOL(rtk_vlan_set);
EXPORT_SYMBOL(rtk_vlan_get);
EXPORT_SYMBOL(rtk_vlan_egrFilterEnable_set);
EXPORT_SYMBOL(rtk_vlan_egrFilterEnable_get);
EXPORT_SYMBOL(rtk_vlan_mbrCfg_set);
EXPORT_SYMBOL(rtk_vlan_mbrCfg_get);
...
EXPORT_SYMBOL(rtk_vlan_keep_set);
EXPORT_SYMBOL(rtk_vlan_keep_get);
EXPORT_SYMBOL(rtk_vlan_stg_set);
EXPORT_SYMBOL(rtk_vlan_stg_get);
EXPORT_SYMBOL(rtk_vlan_protoAndPortBasedVlan_add);
EXPORT_SYMBOL(rtk_vlan_protoAndPortBasedVlan_get);
EXPORT_SYMBOL(rtk_vlan_protoAndPortBasedVlan_del);
EXPORT_SYMBOL(rtk_vlan_protoAndPortBasedVlan_delAll);
EXPORT_SYMBOL(rtk_vlan_portFid_set);
EXPORT_SYMBOL(rtk_vlan_portFid_get);
EXPORT_SYMBOL(rtk_vlan_UntagDscpPriorityEnable_set);
EXPORT_SYMBOL(rtk_vlan_UntagDscpPriorityEnable_get);
EXPORT_SYMBOL(rtk_stp_mstpState_set);
EXPORT_SYMBOL(rtk_stp_mstpState_get);
EXPORT_SYMBOL(rtk_vlan_checkAndCreateMbr);
EXPORT_SYMBOL(rtk_vlan_reservedVidAction_set);
EXPORT_SYMBOL(rtk_vlan_reservedVidAction_get);
EXPORT_SYMBOL(rtk_vlan_realKeepRemarkEnable_set);
EXPORT_SYMBOL(rtk_vlan_realKeepRemarkEnable_get);
EXPORT_SYMBOL(rtk_vlan_reset);
