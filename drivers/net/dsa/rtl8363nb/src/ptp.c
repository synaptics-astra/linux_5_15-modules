...
EXPORT_SYMBOL(rtk_ptp_init);
EXPORT_SYMBOL(rtk_ptp_mac_set);
EXPORT_SYMBOL(rtk_ptp_mac_get);
EXPORT_SYMBOL(rtk_ptp_tpid_set);
EXPORT_SYMBOL(rtk_ptp_tpid_get);
EXPORT_SYMBOL(rtk_ptp_refTime_set);
EXPORT_SYMBOL(rtk_ptp_refTime_get);
EXPORT_SYMBOL(rtk_ptp_refTimeAdjust_set);
EXPORT_SYMBOL(rtk_ptp_refTimeEnable_set);
EXPORT_SYMBOL(rtk_ptp_refTimeEnable_get);
EXPORT_SYMBOL(rtk_ptp_portEnable_set);
EXPORT_SYMBOL(rtk_ptp_portEnable_get);
EXPORT_SYMBOL(rtk_ptp_portTimestamp_get);
EXPORT_SYMBOL(rtk_ptp_intControl_set);
EXPORT_SYMBOL(rtk_ptp_intControl_get);
EXPORT_SYMBOL(rtk_ptp_intStatus_get);
EXPORT_SYMBOL(rtk_ptp_portIntStatus_set);
EXPORT_SYMBOL(rtk_ptp_portIntStatus_get);
EXPORT_SYMBOL(rtk_ptp_portTrap_set);
EXPORT_SYMBOL(rtk_ptp_portTrap_get);
