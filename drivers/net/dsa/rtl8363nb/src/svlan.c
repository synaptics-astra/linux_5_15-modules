...
EXPORT_SYMBOL(rtk_svlan_memberPortEntry_adv_set);
EXPORT_SYMBOL(rtk_svlan_memberPortEntry_adv_get);
EXPORT_SYMBOL(rtk_svlan_defaultSvlan_set);
EXPORT_SYMBOL(rtk_svlan_defaultSvlan_get);
EXPORT_SYMBOL(rtk_svlan_c2s_add);
EXPORT_SYMBOL(rtk_svlan_c2s_del);
EXPORT_SYMBOL(rtk_svlan_c2s_get);
EXPORT_SYMBOL(rtk_svlan_untag_action_set);
EXPORT_SYMBOL(rtk_svlan_untag_action_get);
EXPORT_SYMBOL(rtk_svlan_unmatch_action_set);
EXPORT_SYMBOL(rtk_svlan_unmatch_action_get);
...
EXPORT_SYMBOL(rtk_svlan_unassign_action_set);
EXPORT_SYMBOL(rtk_svlan_unassign_action_get);
EXPORT_SYMBOL(rtk_svlan_checkAndCreateMbr);
