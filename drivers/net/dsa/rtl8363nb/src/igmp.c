...
EXPORT_SYMBOL(rtk_igmp_init);
EXPORT_SYMBOL(rtk_igmp_state_set);
EXPORT_SYMBOL(rtk_igmp_state_get);
EXPORT_SYMBOL(rtk_igmp_static_router_port_set);
EXPORT_SYMBOL(rtk_igmp_static_router_port_get);
EXPORT_SYMBOL(rtk_igmp_protocol_set);
EXPORT_SYMBOL(rtk_igmp_protocol_get);
EXPORT_SYMBOL(rtk_igmp_fastLeave_set);
EXPORT_SYMBOL(rtk_igmp_fastLeave_get);
EXPORT_SYMBOL(rtk_igmp_maxGroup_set);
EXPORT_SYMBOL(rtk_igmp_maxGroup_get);
EXPORT_SYMBOL(rtk_igmp_currentGroup_get);
EXPORT_SYMBOL(rtk_igmp_tableFullAction_set);
EXPORT_SYMBOL(rtk_igmp_tableFullAction_get);
EXPORT_SYMBOL(rtk_igmp_checksumErrorAction_set);
EXPORT_SYMBOL(rtk_igmp_checksumErrorAction_get);
EXPORT_SYMBOL(rtk_igmp_leaveTimer_set);
EXPORT_SYMBOL(rtk_igmp_leaveTimer_get);
EXPORT_SYMBOL(rtk_igmp_queryInterval_set);
EXPORT_SYMBOL(rtk_igmp_queryInterval_get);
EXPORT_SYMBOL(rtk_igmp_robustness_set);
EXPORT_SYMBOL(rtk_igmp_robustness_get);
EXPORT_SYMBOL(rtk_igmp_dynamicRouterPortAllow_set);
EXPORT_SYMBOL(rtk_igmp_dynamicRouterPortAllow_get);
EXPORT_SYMBOL(rtk_igmp_dynamicRouterPort_get);
EXPORT_SYMBOL(rtk_igmp_suppressionEnable_set);
EXPORT_SYMBOL(rtk_igmp_suppressionEnable_get);
EXPORT_SYMBOL(rtk_igmp_portRxPktEnable_set);
EXPORT_SYMBOL(rtk_igmp_portRxPktEnable_get);
EXPORT_SYMBOL(rtk_igmp_groupInfo_get);
EXPORT_SYMBOL(rtk_igmp_ReportLeaveFwdAction_set);
EXPORT_SYMBOL(rtk_igmp_ReportLeaveFwdAction_get);
EXPORT_SYMBOL(rtk_igmp_dropLeaveZeroEnable_set);
EXPORT_SYMBOL(rtk_igmp_dropLeaveZeroEnable_get);
EXPORT_SYMBOL(rtk_igmp_bypassGroupRange_set);
EXPORT_SYMBOL(rtk_igmp_bypassGroupRange_get);
