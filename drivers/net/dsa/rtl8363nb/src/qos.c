...
EXPORT_SYMBOL(rtk_qos_dscpRemark2Dscp_set);
EXPORT_SYMBOL(rtk_qos_dscpRemark2Dscp_get);
EXPORT_SYMBOL(rtk_qos_portPriSelIndex_set);
EXPORT_SYMBOL(rtk_qos_portPriSelIndex_get);
