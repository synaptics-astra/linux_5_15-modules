...
EXPORT_SYMBOL(rtk_l2_addr_next_get);
EXPORT_SYMBOL(rtk_l2_addr_del);
EXPORT_SYMBOL(rtk_l2_mcastAddr_add);
EXPORT_SYMBOL(rtk_l2_mcastAddr_get);
EXPORT_SYMBOL(rtk_l2_mcastAddr_next_get);
EXPORT_SYMBOL(rtk_l2_mcastAddr_del);
EXPORT_SYMBOL(rtk_l2_ipMcastAddr_add);
EXPORT_SYMBOL(rtk_l2_ipMcastAddr_get);
EXPORT_SYMBOL(rtk_l2_ipMcastAddr_next_get);
EXPORT_SYMBOL(rtk_l2_ipMcastAddr_del);
EXPORT_SYMBOL(rtk_l2_ipVidMcastAddr_add);
EXPORT_SYMBOL(rtk_l2_ipVidMcastAddr_get);
EXPORT_SYMBOL(rtk_l2_ipVidMcastAddr_next_get);
EXPORT_SYMBOL(rtk_l2_ipVidMcastAddr_del);
EXPORT_SYMBOL(rtk_l2_ucastAddr_flush);
EXPORT_SYMBOL(rtk_l2_table_clear);
EXPORT_SYMBOL(rtk_l2_table_clearStatus_get);
EXPORT_SYMBOL(rtk_l2_flushLinkDownPortAddrEnable_set);
EXPORT_SYMBOL(rtk_l2_flushLinkDownPortAddrEnable_get);
EXPORT_SYMBOL(rtk_l2_agingEnable_set);
EXPORT_SYMBOL(rtk_l2_agingEnable_get);
EXPORT_SYMBOL(rtk_l2_limitLearningCnt_set);
EXPORT_SYMBOL(rtk_l2_limitLearningCnt_get);
EXPORT_SYMBOL(rtk_l2_limitSystemLearningCnt_set);
EXPORT_SYMBOL(rtk_l2_limitSystemLearningCnt_get);
EXPORT_SYMBOL(rtk_l2_limitLearningCntAction_set);
EXPORT_SYMBOL(rtk_l2_limitLearningCntAction_get);
EXPORT_SYMBOL(rtk_l2_limitSystemLearningCntAction_set);
EXPORT_SYMBOL(rtk_l2_limitSystemLearningCntAction_get);
EXPORT_SYMBOL(rtk_l2_limitSystemLearningCntPortMask_set);
EXPORT_SYMBOL(rtk_l2_limitSystemLearningCntPortMask_get);
EXPORT_SYMBOL(rtk_l2_learningCnt_get);
EXPORT_SYMBOL(rtk_l2_floodPortMask_set);
EXPORT_SYMBOL(rtk_l2_floodPortMask_get);
EXPORT_SYMBOL(rtk_l2_localPktPermit_set);
EXPORT_SYMBOL(rtk_l2_localPktPermit_get);
EXPORT_SYMBOL(rtk_l2_aging_set);
EXPORT_SYMBOL(rtk_l2_aging_get);
EXPORT_SYMBOL(rtk_l2_ipMcastAddrLookup_set);
EXPORT_SYMBOL(rtk_l2_ipMcastAddrLookup_get);
EXPORT_SYMBOL(rtk_l2_ipMcastForwardRouterPort_set);
EXPORT_SYMBOL(rtk_l2_ipMcastForwardRouterPort_get);
EXPORT_SYMBOL(rtk_l2_ipMcastGroupEntry_add);
EXPORT_SYMBOL(rtk_l2_ipMcastGroupEntry_del);
EXPORT_SYMBOL(rtk_l2_ipMcastGroupEntry_get);
EXPORT_SYMBOL(rtk_l2_entry_get);
