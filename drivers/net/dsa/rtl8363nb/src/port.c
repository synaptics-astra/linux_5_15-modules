...
EXPORT_SYMBOL(rtk_port_macForceLinkExt_set);
EXPORT_SYMBOL(rtk_port_macForceLinkExt_get);
//EXPORT_SYMBOL(rtk_port_macForceLinkExtSSC_set);
...
EXPORT_SYMBOL(rtk_port_rgmiiDelayExt_set);
EXPORT_SYMBOL(rtk_port_rgmiiDelayExt_get);
EXPORT_SYMBOL(rtk_port_phyEnableAll_set);
EXPORT_SYMBOL(rtk_port_phyEnableAll_get);
EXPORT_SYMBOL(rtk_port_efid_set);
EXPORT_SYMBOL(rtk_port_efid_get);
